...
const Login = () => {
    ...
    return (
        <>
            <NavBar />
            <div className="flex min-h-[calc(100vh-64px)] items-center justify-center bg-green-100 px-3 py-4 sm:px-6 lg:px-8">
                <div className="absolute inset-0 bg-gradient-to-r from-green-400/10 to-green-600/10"></div>
                <div className="relative mt-6 w-full max-w-sm space-y-4">
                        ...
                        >
                            ...
                            <div className="border-t border-green-200 pt-4 text-center">
                                <p className="text-xs text-gray-700">
                                    ...
                                    <Link
                                        to="/signup"
                                        className="font-semibold text-green-600 transition duration-200 hover:text-gray-800 hover:underline focus:underline focus:outline-none"
                                    >
                                        Create new account
                                    </Link>
                                </p>
